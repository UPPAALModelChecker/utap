...
namespace UTAP
{
    ...
    */
    struct variable_t : public stringify_t<variable_t>
    {
    ...
    */
    struct location_t : public stringify_t<location_t>
    {
    ...
    /** Information about an edge.  Edges have a source (src) and a
        ...
        expressions.
    */
    struct edge_t : public stringify_t<edge_t>
    {
    ...
    */
    struct function_t : public stringify_t<function_t>
    {
     ...
     */
    struct template_t;
    struct declarations_t : public stringify_t<declarations_t>
    {
        frame_t frame;
    ...
    struct simregion_t : public stringify_t<simregion_t>
    {
        int nr{};
    ...
    struct cut_t : public stringify_t<cut_t>
    {
        int nr;
    ...
    struct instance_t
    {
        ...
        size_t arguments;
        size_t unbound; /**< The number of unbound parameters */
    ...
    struct template_t : public instance_t, declarations_t
    {
        ...
        bool is_invariant();  // type of the LSC
     ...
     */
    struct chan_priority_t : public stringify_t<chan_priority_t>
    {
